...
2.  [Python - Object-Oriented](https://www.tutorialspoint.com/python/python_classes_objects.htm). Kelas modular menggunakan [mixins](https://www.residentmar.io/2019/07/07/python-mixins.html).
