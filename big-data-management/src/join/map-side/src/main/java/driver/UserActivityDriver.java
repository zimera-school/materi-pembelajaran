...
import reducer.UserActivityReducer;
import vo.UserActivityVO;
...
public class UserActivityDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		//job.addCacheFile(new URI("hdfs://localhost:9000/input-logs/user.log"));
		job.addCacheFile(new URI("input-logs/user.log"));
